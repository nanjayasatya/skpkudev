<div id="layoutSidenav_content">
                ...
                <div class="page-header-content pt-4">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            ...
                            <div class="page-header-subtitle">Mengubah data SKP B Mahasiswa terkait</div>
                        </div>
            ...
            <div class="mt-3 mb-4">
                <div class="card h-100">
                    <div class="card-body h-100 justify-content-center">
                        <?php echo form_open_multipart('staffbem/editskpbdata/' . $this->uri->segment(3)); ?>
                        <form action="<?= base_url('staffbem/editskpbdata/' . $this->uri->segment(3)); ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            <input id="csrf_token " type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
                            <div class="form-group text-center mt-3">
                                <label for="event" class="font-weight-700">Nama Kegiatan/Keterangan</label>
                                <input type="text" class="form-control" id="event" name="event" placeholder="" maxlength="70" value="<?= $sad['event']; ?>">
                                <?= form_error('event', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group text-center">
                                <label for="posisi" class="font-weight-700">Posisi</label>
                                <input type="text" class="form-control" id="posisi" name="posisi" placeholder="" maxlength="18" value="<?= $sad['posisi']; ?>">
                    ...
                    <div class="text-center mb-5">
                        ...
                        <div class="mt-2">
                            <a href="<?= base_url('staffbem/inputskpbuser/') . $uda['id']; ?>" class="btn btn-lg btn-dark btn-icon-split">
                                <span class="icon text-white-50">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="areyousureDeleteSKPADataModalLabel">Hapus Data SKP B</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                </div>
                <div class="modal-body">Apakah yakin menghapus data SKP B ini ?</div>
                <div class="modal-footer"><button class="btn btn-dark" type="button" data-dismiss="modal">Batal</button><a href="<?= base_url('staffbem/deleteskpbdata/') . $sad['id']; ?>" class="btn btn-danger">Lanjutkan</a></div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="areyousureModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="areyousureModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="areyousureModalLabel">Ubah Data SKP B</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                </div>
