                ...
                <div class="page-header-content pt-4">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            ...
                            <div class="page-header-subtitle">Informasi lengkap mengenai Data SKP B Mahasiswa</div>
                        </div>
                        <div class="col-12 col-xl-auto mt-4">Tekan tombol "Data SKP B" untuk melihat Data SKP B Mahasiswa terkait!</div>
                    </div>
                </div>
            </div>
        </header>
                                    ...
                                    <?php foreach ($userDatabaseMahasiswa as $ud) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('staffbem/inputskpbuser/') . $ud['id']; ?>" class="btn btn-purple btn-icon-split">
                                                    <span class="icon text-white-50">
                                                        <i class="fas fa-info-circle"></i>
                                                    </span>
                                                    <span class="text" style="width:120px">Data SKP B</span>
                                                </a>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
