                ...
                <div class="page-header-content pt-4">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            ...
                            <div class="page-header-subtitle">Menerima atau menolak pengajuan sertifikat kegiatan BSO/SK</div>
                        </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body mb-3">
                    <table id="listvalidasi" class="table table-bordered table-hover dataTable" style="width:100%">
                        ...
                        <tbody>
                            <?php $i = 1; ?>
                            <?php foreach ($listsertifvalidation as $lv) : ?>
                                <tr>
                                    <th scope="row"><?= $i ?></th>
                                    <td><?= $lv['pelaksana']; ?></td>
                                    <td><?= $lv['name']; ?></td>
                                    ...
                                    <?php if ($lv['status'] == 0) {
                                        ...
                                        $link = base_url('staffbem/detailvalidasiproposal/') . $lv['id'];
                                    }
                                    ?>
                                    <?php if ($lv['status'] == 5) {
                                        $vali = '<p style="color:orange">Menunggu Validasi BEM (Pengarsipan)</p>';
                                        $link = base_url('staffbem/detailpengarsipan/') . $lv['id'];
                                    }
                                    ?>
                                    <td><?= $vali; ?></td>
                                    <td>
