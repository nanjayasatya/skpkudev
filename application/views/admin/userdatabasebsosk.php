                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            <h1 class="page-header-title">
                                ...
                                User Database (BSO/SK)
                            </h1>
                            <div class="page-header-subtitle">Database User BSO/SK</div>
                        </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body h-100 d-flex flex-column justify-content-center py-5 py-xl-4">
                            <table id="userdatabase" class="table table-bordered table-hover dataTable" style="width:100%">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($userDatabaseBSOSK as $ud) : ?>
                                        <tr>
                                            <th scope="row"><?= $i ?></th>
                                            <td><?= $ud['name']; ?></td>
                                            ...
                                            <td>
                                                ...
                                                <br>
                                                <a href="<?= base_url('admin/userresetpassword/') . $ud['id']; ?>" class="btn btn-danger btn-icon-split mt-2">
                                                    <span class="icon text-white-50">
                        ...
                        <div class="text-center mb-5">
                            <a href="<?= base_url('admin/useraddbsosk') ?> " class="btn btn-lg btn-success btn-icon-split">
