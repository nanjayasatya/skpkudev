<div id="layoutSidenav_content">
        ...
        <div class="container mt-n10">
            <div class="card mb-5">
                <div class="card-body">
                    ...
                    <form action="<?= base_url('dpm/detailpengarsipan/' . $this->uri->segment(3));  ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    ...
    <script type="text/javascript">
        function RejectClick() {
            ...
            window.location.href = "<?= base_url('dpm/rejectvalidasipengarsipan/') . $this->uri->segment(3) . '/' ?>" + rejection_reason;
