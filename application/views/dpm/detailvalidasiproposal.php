                    ...
                    <div class="card-body mb-3">
                        <div class="row justify-content-center">
                            <div class="col-lg-6 text-center">
                                ...
                                <form action="<?= base_url('dpm/detailvalidasiproposal/' . $this->uri->segment(3)); ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                            ...
                                            <td>
                                                ...
                                                <script type="text/javascript">
                                                    function ChangeNotBantuanDanaStatus(data) {
                                                        ...
                                                        $.ajax({
                                                            url: "<?= base_url('dpm/changeStatusProposalValidation/'); ?>" + uriSegment,
                                                            type: 'post',
                                                            data: {
                            ...
                            <div class="row">
                                <div class="col-lg">
                                    <a href="<?= base_url('dpm/validasiproposal'); ?>" type="button" class="btn btn-dark btn-icon-split mt-2">
                                        <span class="icon text-white-50">
                                    ...
                                    <button type="button" data-toggle="modal" data-target="#areyousurevalidateModal" class="btn btn-success btn-icon-split mt-2">
                                        ...
                                        <span class="text" style="width:180px">Validasi Diterima</span>
                                    </button>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    function RejectClick() {
        ...
        window.location.href = "<?= base_url('dpm/rejectvalidasiproposal/') . $this->uri->segment(3) . '/' ?>" + rejection_reason;
