  ...
  <main>
    ...
    <div class="container mt-n10">
      <div class="row">
        ...
        <?php foreach ($totaleventdata as $ted) : ?>
          <div class="col-xxl-3 col-lg-6">
            <div class="card bg-danger text-white mb-4">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                  <div class="mr-3">
                    <div class="text-white-75 small">Total Data Kegiatan Pada Database BEM</div>
                    <div class="text-lg font-weight-bold"><?= $ted ?></div>
                  </div>

                  <i class="text-white-50 fas fa-database fa-3x"></i>
